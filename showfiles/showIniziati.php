...
$user_id= $_SESSION['users_id'];
 ...
 if($categoria==null || $categoria=='tutto'){
    ...
    $concacategoria=" AND video_con_category.id_category='$categoria'";
